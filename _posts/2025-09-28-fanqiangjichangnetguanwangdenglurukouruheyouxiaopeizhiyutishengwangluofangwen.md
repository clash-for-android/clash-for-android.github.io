...
<ul>
    ...
    <li>
        <strong>选择与激活节点：</strong> 导入成功后，您可以在“Proxies”（代理）或“节点”界面看到所有可用的<strong>Clash 节点</strong>。选择一个您认为合适的节点，例如地理位置较近或延迟较低的节点。最后，在“General”（通用）或“设置”中，启用“System Proxy”（系统代理），Clash便会开始接管您的网络流量。
    </li>
</ul>
